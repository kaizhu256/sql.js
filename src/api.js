...
Module["onRuntimeInitialized"] = function onRuntimeInitialized() {
    ...
    * @param {Database} db The database from which this statement was created
    ...
    /** @typedef {
        Database.SqlValue[]|Object<string,
    ...
    */
    ...
    @param {function():void} done A function that will be called when all rows
    have been retrieved
    ...
    */
    ...
    @param {string} name the name of the function as referenced in SQL
    statements.
