...
For each [release](https://github.com/sql-js/sql.js/releases/), you will find a file called `sqljs.zip` in the *release assets*. It will contain:
 ...
 - `sql-asm.js` : The older asm.js version of Sql.js. Slower and larger. Provided for compatibility reasons. Includes memory-growth support.
 - `sql-asm-memory-growth.js` : DEPRECATED and will be removed in future releases. Use sql-asm.js, which now includes memory-growth support.
